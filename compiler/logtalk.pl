...
% '$lgt_needs_resplitting'(+atom)
%
% true when source metafile needs resplitting; assumes that the user does 
...
% '$lgt_create_loader_file'(+atom, +list, +list)
%
