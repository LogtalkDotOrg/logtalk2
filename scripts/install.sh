...
rm -rf $prefix/share/lgt2382
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2382

cd ..
cp -R * $prefix/share/lgt2382

cd $prefix/share/lgt2382
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2382 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2382/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
