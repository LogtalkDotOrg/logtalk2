...
rm -rf $prefix/share/lgt2410
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2410

cd ..
cp -R * $prefix/share/lgt2410

cd $prefix/share/lgt2410
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2410 logtalk
...
echo "* ECLiPSe (version 6.0#77 or later):     eclipselgt"
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2410/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
