...
rm -rf $prefix/share/lgt2421
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2421

cd ..
cp -R * $prefix/share/lgt2421

cd $prefix/share/lgt2421
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2421 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2421/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
