...
rm -rf $prefix/share/lgt2420
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2420

cd ..
cp -R * $prefix/share/lgt2420

cd $prefix/share/lgt2420
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2420 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2420/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
