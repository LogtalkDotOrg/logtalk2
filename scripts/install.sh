...
rm -rf $prefix/share/lgt2392
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2392

cd ..
cp -R * $prefix/share/lgt2392

cd $prefix/share/lgt2392
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2392 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2392/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
