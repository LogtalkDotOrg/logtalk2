...
rm -rf $prefix/share/lgt2441
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2441

cd ..
cp -R * $prefix/share/lgt2441

cd $prefix/share/lgt2441
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2441 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2441/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
