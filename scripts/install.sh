...
rm -rf $prefix/share/lgt2422
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2422

cd ..
cp -R * $prefix/share/lgt2422

cd $prefix/share/lgt2422
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2422 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2422/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
