...
rm -rf $prefix/share/lgt2383
rm -f $prefix/share/logtalk

mkdir $prefix/share/lgt2383

cd ..
cp -R * $prefix/share/lgt2383

cd $prefix/share/lgt2383
chmod a+x scripts/cleandist.sh
scripts/cleandist.sh

cd ..
ln -sf lgt2383 logtalk
...
if [ "`which update-mime-database`" != "" ]; then
	...
	cp $prefix/share/lgt2383/scripts/freedesktop/logtalk.xml $prefix/share/mime/packages/logtalk.xml
