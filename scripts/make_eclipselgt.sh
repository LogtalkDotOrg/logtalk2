...
echo ":- tool(abolish/1,abolish_/2)." >> logtalk_eclipse.pl
echo "abolish_(Pred, Mod) :- (current_predicate(Pred)@Mod -> eclipse_language:abolish(Pred)@Mod; true)." >> logtalk_eclipse.pl
