...
#define MyAppVerName "Logtalk 2.41.0"
...
OutputBaseFilename=lgt2410
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=2.41.0
...
[Messages]
BeveledLabel=Logtalk 2.41.0 © Paulo Moura, 1998-2010
...
[Registry]
Root: HKLM; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2410"; Components: base; Flags: deletevalue uninsdeletevalue
...
begin
  ...
  if RegQueryDWordValue(HKLM, 'Software\Logtalk\', 'Version', Version) then
    ...
    InstalledVersion := -1;
  if IsAdminLoggedOn and (InstalledVersion >= 0) and (InstalledVersion < 2410) then
  begin
