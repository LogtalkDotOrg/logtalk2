...
#define MyAppVerName "Logtalk 2.43.4"
...
OutputBaseFilename=lgt2433
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=2.43.4
...
Name: "prolog\bp"; Description: "B-Prolog integration (version 7.5#8 or later)"; Types: full prolog custom; Flags: disablenouninstallwarning
...
Name: "prolog\lean"; Description: "Lean Prolog Prolog integration (version 2.19.0 or later)"; Types: full prolog custom; Flags: disablenouninstallwarning
...
[Messages]
BeveledLabel=Logtalk 2.43.4 © Paulo Moura, Copyright (c) 1998-2012
...
[Registry]
; admin users
Root: HKLM; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2433"; Components: base; Flags: deletevalue uninsdeletevalue; Check: IsAdminLoggedOn
...
; non-admin users
Root: HKCU; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2433"; Components: base; Flags: deletevalue uninsdeletevalue; Check: not IsAdminLoggedOn
...
begin
  ...
  if RegQueryDWordValue(HKCU, 'Software\Logtalk', 'Version', Version) then
    ...
    InstalledVersion := -1;
  if (InstalledVersion >= 0) and (InstalledVersion < 2433) then
  begin
