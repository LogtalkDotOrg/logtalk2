...
#define MyAppVerName "Logtalk 2.35.2"
...
OutputBaseFilename=lgt2352
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=2.35.2
...
[Messages]
BeveledLabel=Logtalk 2.35.2 © Paulo Moura, 1998-2009
...
Source: "{#MyBaseDir}\settings.pl"; DestDir: "{code:GetLgtUserDir}"; DestName: "settings.pl"; Components: user; Flags: ignoreversion uninsneveruninstall
...
Name: "{group}\Logtalk - SWI-Prolog"; Filename: "{code:GetSWIExePath}"; Parameters: "-s ""%LOGTALKHOME%\integration\logtalk_swi.pl"""; Comment: "Runs Logtalk with SWI-Prolog"; WorkingDir: "{code:GetLgtUserDir}"; Components: prolog\swi; Flags: createonlyiffileexists
...
[Registry]
Root: HKLM; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2352"; Components: base; Flags: deletevalue uninsdeletevalue
...
begin
  ...
  if RegQueryDWordValue(HKLM, 'Software\Logtalk\', 'Version', Version) then
    ...
    InstalledVersion := -1;
  if IsAdminLoggedOn and (InstalledVersion >= 0) and (InstalledVersion < 2352) then
  begin
