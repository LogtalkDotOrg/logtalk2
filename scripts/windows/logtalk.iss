...
#define MyAppVerName "Logtalk 2.32.1"
...
OutputBaseFilename=lgt2321
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=2.32.1
...
[Messages]
BeveledLabel=Logtalk 2.32.1 © Paulo Moura, 1998-2008
...
[Registry]
Root: HKLM; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2321"; Components: base; Flags: deletevalue uninsdeletevalue
...
begin
  ...
  if RegQueryDWordValue(HKLM, 'Software\Logtalk\', 'Version', Version) then
    ...
    InstalledVersion := -1;
  if IsAdminLoggedOn and (InstalledVersion >= 0) and (InstalledVersion < 2320) then
  begin
