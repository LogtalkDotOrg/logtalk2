...
#define MyAppVerName "Logtalk 2.35.1"
...
OutputBaseFilename=lgt2351
Compression=lzma
SolidCompression=yes
PrivilegesRequired=none

VersionInfoVersion=2.35.1
...
[Messages]
BeveledLabel=Logtalk 2.35.1 © Paulo Moura, 1998-2009
...
[Registry]
Root: HKLM; Subkey: "Software\Logtalk"; ValueType: dword; ValueName: "Version"; ValueData: "2351"; Components: base; Flags: deletevalue uninsdeletevalue
...
begin
  ...
  if RegQueryDWordValue(HKLM, 'Software\Logtalk\', 'Version', Version) then
    ...
    InstalledVersion := -1;
  if IsAdminLoggedOn and (InstalledVersion >= 0) and (InstalledVersion < 2351) then
  begin
