...
svn export http://svn.logtalk.org/logtalk/trunk lgt2431
...
cd ..
cp -R lgt2431/manuals man2431
tar -czf man2431.tgz man2431
tar -cjf lgt2431.tar.bz2 lgt2431
...
cd $dir
dpkg-deb --build debian logtalk_2.43.1-1_all.deb

md5="`md5 -q lgt2431.tar.bz2`"
sha1="`openssl sha1 -r lgt2431.tar.bz2 | xargs -L 1 | sed 's/*lgt2431.tar.bz2//g'`"
rmd160="`openssl rmd160 -r lgt2431.tar.bz2 | xargs -L 1 | sed 's/*lgt2431.tar.bz2//g'`"
sudo mkdir -p /opt/local/var/macports/distfiles/logtalk
sudo cp -f lgt2431.tar.bz2 /opt/local/var/macports/distfiles/logtalk/lgt2431.tar.bz2
cd /opt/local/var/macports/sources/rsync.macports.org/release/ports/lang/logtalk/
sudo mv -f Portfile Portfile.old
sudo cp $dir/lgt2431/scripts/macosx/Portfile .
sudo sed -e 's/^version.*/version 2.43.1/' -i '' Portfile
...
cp -R work/logtalk-2.43.1.pkg $dir
...
cd man2431/userman
./userman.sh
mv userman.pdf ../../manpdf2431/lgtuserman2431.pdf
cd ../refman
./refman.sh
mv refman.pdf ../../manpdf2431/lgtrefman2431.pdf
cd ../..
tar -czf manpdf2431.tgz manpdf2431
