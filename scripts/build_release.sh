...
cd ..
cp -R logtalk/manuals man2340
tar -czf man2340.tgz man2340
mv logtalk lgt2340
tar -cjf lgt2340.tar.bz2 lgt2340
...
cd $dir
dpkg-deb --build debian logtalk_2.34.0-1_all.deb

md5="`md5 -q lgt2340.tar.bz2`"
sudo mkdir -p /opt/local/var/macports/distfiles/logtalk
sudo cp -f lgt2340.tar.bz2 /opt/local/var/macports/distfiles/logtalk/lgt2340.tar.bz2
cd /opt/local/var/macports/sources/rsync.macports.org/release/ports/lang/logtalk/
sudo cp -f Portfile Portfile.old
sudo sed -e 's/^version.*/version 2.34.0/' -i '' Portfile
...
cp -R work/logtalk-2.34.0.pkg $dir
...
cd man2340/userman
./userman.sh
mv userman.pdf ../../manpdf2340
cd ../refman
./refman.sh
mv refman.pdf ../../manpdf2340
cd ../..
tar -czf manpdf2340.tgz manpdf2340
