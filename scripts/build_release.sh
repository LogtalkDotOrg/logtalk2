...
svn export http://svn.logtalk.org/logtalk/trunk lgt2391
...
cd ..
cp -R lgt2391/manuals man2391
tar -czf man2391.tgz man2391
tar -cjf lgt2391.tar.bz2 lgt2391
...
cd $dir
dpkg-deb --build debian logtalk_2.39.1-1_all.deb

md5="`md5 -q lgt2391.tar.bz2`"
sudo mkdir -p /opt/local/var/macports/distfiles/logtalk
sudo cp -f lgt2391.tar.bz2 /opt/local/var/macports/distfiles/logtalk/lgt2391.tar.bz2
cd /opt/local/var/macports/sources/rsync.macports.org/release/ports/lang/logtalk/
sudo mv -f Portfile Portfile.old
sudo cp $dir/lgt2391/scripts/macosx/Portfile .
sudo sed -e 's/^version.*/version 2.39.1/' -i '' Portfile
...
cp -R work/logtalk-2.39.1.pkg $dir
...
cd man2391/userman
./userman.sh
mv userman.pdf ../../manpdf2391/lgtuserman2391.pdf
cd ../refman
./refman.sh
mv refman.pdf ../../manpdf2391/lgtrefman2391.pdf
cd ../..
tar -czf manpdf2391.tgz manpdf2391
