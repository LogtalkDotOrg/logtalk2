...
svn export http://svn.logtalk.org/logtalk/trunk lgt2432
...
cd ..
cp -R lgt2432/manuals man2432
tar -czf man2432.tgz man2432
tar -cjf lgt2432.tar.bz2 lgt2432
...
cd $dir
dpkg-deb --build debian logtalk_2.43.2-1_all.deb

md5="`md5 -q lgt2432.tar.bz2`"
sha1="`openssl sha1 -r lgt2432.tar.bz2 | xargs -L 1 | sed 's/*lgt2432.tar.bz2//g'`"
rmd160="`openssl rmd160 -r lgt2432.tar.bz2 | xargs -L 1 | sed 's/*lgt2432.tar.bz2//g'`"
sudo mkdir -p /opt/local/var/macports/distfiles/logtalk
sudo cp -f lgt2432.tar.bz2 /opt/local/var/macports/distfiles/logtalk/lgt2432.tar.bz2
cd /opt/local/var/macports/sources/rsync.macports.org/release/ports/lang/logtalk/
sudo mv -f Portfile Portfile.old
sudo cp $dir/lgt2432/scripts/macosx/Portfile .
sudo sed -e 's/^version.*/version 2.43.2/' -i '' Portfile
...
cp -R work/logtalk-2.43.2.pkg $dir
...
cd man2432/userman
./userman.sh
mv userman.pdf ../../manpdf2432/lgtuserman2432.pdf
cd ../refman
./refman.sh
mv refman.pdf ../../manpdf2432/lgtrefman2432.pdf
cd ../..
tar -czf manpdf2432.tgz manpdf2432
