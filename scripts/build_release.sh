...
cd ..
cp -R logtalk/manuals man2351
tar -czf man2351.tgz man2351
mv logtalk lgt2351
tar -cjf lgt2351.tar.bz2 lgt2351
...
cd $dir
dpkg-deb --build debian logtalk_2.35.1-1_all.deb

md5="`md5 -q lgt2351.tar.bz2`"
...
cp -R work/logtalk-2.35.1.pkg $dir
...
cd man2351/userman
./userman.sh
mv userman.pdf ../../manpdf2351
cd ../refman
./refman.sh
mv refman.pdf ../../manpdf2351
cd ../..
tar -czf manpdf2351.tgz manpdf2351
